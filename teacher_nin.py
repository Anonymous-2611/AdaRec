...
from options import nextitnet_parser
...
if __name__ == "__main__":
    ...
    model = NextItNet(args).cuda()
    logging.info("dilations: {} * {}".format(args.nin_num_blocks, args.nin_block_dilations))
    logging.info("\t = {}".format(model.dilations))
